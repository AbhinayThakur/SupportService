...
<html lang="en">
  ...
  <body>
    <div style="margin: 0px 0px 0px 0px; background-color: #ededee;">
    <div>
      <a href="http://healthelife.in/"><img src="http://ehr.healthelife.in:8080/ehr/assets/logo.png" alt="HealtheLife" style="width: 180px; height: 45px; margin-left:0;margin-top: 20px; margin-bottom: 10px; margin-left: 50px;"></a>
    </div>

    <!--content-->

    <div style="font-family: 'Roboto', sans-serif; font-size: 15px; font-weight: 350; background-color: #fff; margin-left: 50px; margin-right: 50px; margin-top: 10px; margin-bottom: 50px;">
